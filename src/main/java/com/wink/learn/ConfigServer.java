...
/**
 * description: com.wink.learn.ConfigServer <br>
 * date: 2021/6/23 下午5:53 <br>
 * author: kuan <br>
 * version: 1.0 <br>
 */
@RestController
...
public class ConfigServer {
    ...
    public String publishConfig(String dataId, String configInfo) throws IOException {
        System.out.println("publish configInfo dataId: ["+dataId+"], configInfo: "+configInfo+"");
