...
/**
 * description: ConfigClient <br>
 * date: 2021/6/23 上午11:49 <br>
 * author: kuan <br>
 * version: 1.0 <br>
 */
@Slf4j
    ...
    public void longPolling(String url, String dataId) throws IOException {
        ...
        switch (response.getStatusLine().getStatusCode()) {
            case 200: {
                ...
                System.out.println("dataId: ["+dataId+"] changed, receive configInfo: "+configInfo+"");
                longPolling(url, dataId);
                break;
            }
            // ② 304 响应码标记配置未变更
            case 304: {
                System.out.println("longPolling dataId: ["+dataId+"] once finished, configInfo is unchanged, longPolling again");
                longPolling(url, dataId);
                break;
            }
            default: {
